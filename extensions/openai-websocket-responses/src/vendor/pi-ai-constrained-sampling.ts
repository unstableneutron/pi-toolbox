/**
 * Vendored constrained-sampling helpers from @earendil-works/pi-ai 0.82.0.
 *
 * Pi's extension resolver aliases the pi-ai package root to its compatibility
 * entrypoint, so package subpath imports are not reliable inside extensions.
 * Keep this small adapter aligned with pi-ai's public helper behavior.
 */
